    ...
    <div className="container">
      ...
      {information && (
        <div className="p-5">
          ...
          <p>ID User: {information.user._id}</p>
      ...
      <div className="table-responsive pt-5 pb-5">
        <table className="table">
          ...
          <tbody>
            {cart && (
              <tr className="text-center" key={cart.product._id}>
                <td className="align-middle border-0">
                  <Link
                    className="reset-anchor d-block animsition-link"
                    to={`/detail/${cart.product._id}`}
                  >
                    <h6 className="mb-0">{cart.product._id}</h6>
                  </Link>
                </td>
                <td className="pl-0 border-0">
                  <div className="media align-items-center justify-content-center">
                    <Link
                      ...
                      to={`/detail/${cart.product._id}`}
                    >
                      <img src={cart.product.img1} alt="..." width="100" />
                    </Link>
                  </div>
                </td>
                <td className="align-middle border-0">
                ...
                <td className="align-middle border-0">
                  <h6 className="mb-0">{cart.product.price}</h6>
                </td>
                <td className="align-middle border-0">
                  <h6 className="mb-0">{cart.quantity}</h6>
                </td>
              </tr>
            )}
          </tbody>
