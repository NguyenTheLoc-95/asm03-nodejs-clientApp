...
const socket = io("https://server-asm3.onrender.com/");
...
function Chat(props) {
  ...
  const handlerSend = async () => {
    ...
    //Tiếp theo nó sẽ postdata lên api đưa dữ liệu vào data socket
  ...
  useEffect(() => {
    ...
    if (activeChat === false && messages.length > 0) {
      alert("you have a message from Quan Tri Vien in chat");
    }
  }, [messages.length]);
